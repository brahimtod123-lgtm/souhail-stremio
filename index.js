...
res.send(  <h2>Install Souhail Premium</h2>   <a href="stremio://stremio.xyz/app/${req.hostname}/manifest.json">   Install Addon   </a>   <p>${baseUrl}/manifest.json</p>  );
});
...
هذا انديكس ديال بروجي التاني لي كنا صوبنا . يالله دير خدمتك
